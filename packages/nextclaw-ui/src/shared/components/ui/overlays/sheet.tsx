...
const sheetVariants = cva(
  "fixed z-[var(--z-modal,10050)] bg-background shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ children, className, closeLabel = "Close", side, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
