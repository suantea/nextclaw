    ...
    pub mod portable_service {
        ...
        pub mod host {
            ...
            pub struct ModelCompleteInput {
                pub slot_id: _rt::String,
                pub messages_json: _rt::String,
                pub max_tokens: Option<u32>,
            }
            impl ::core::fmt::Debug for ModelCompleteInput {
                fn fmt(
                    &self,
                    f: &mut ::core::fmt::Formatter<'_>,
                ) -> ::core::fmt::Result {
                    f.debug_struct("ModelCompleteInput")
                        .field("slot-id", &self.slot_id)
            ...
            pub struct AgentStartInput {
                pub slot_id: _rt::String,
                pub input_json: _rt::String,
            }
            impl ::core::fmt::Debug for AgentStartInput {
                fn fmt(
                    &self,
                    f: &mut ::core::fmt::Formatter<'_>,
                ) -> ::core::fmt::Result {
                    f.debug_struct("AgentStartInput")
                        .field("slot-id", &self.slot_id)
                        .field("input-json", &self.input_json)
                        .finish()
                }
            }
            ...
            pub fn model_complete(
                ...
                unsafe {
                    ...
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    let len1 = vec1.len();
                    let vec2 = messages_json0;
                    let ptr2 = vec2.as_ptr().cast::<u8>();
                    let len2 = vec2.len();
                    let (result3_0, result3_1) = match max_tokens0 {
            ...
            pub fn agent_start(
                ...
                unsafe {
                    ...
                    let AgentStartInput { slot_id: slot_id0, input_json: input_json0 } = input;
                    let vec1 = slot_id0;
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    let len1 = vec1.len();
                    let vec2 = input_json0;
                    let ptr2 = vec2.as_ptr().cast::<u8>();
                    let len2 = vec2.len();
                    let ptr3 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
            ...
            pub fn report_progress(
                ...
                unsafe {
                    ...
                    let (result0_0, result0_1) = match current {
                        Some(e) => (1i32, _rt::as_i64(e)),
                        None => (0i32, 0i64),
                    };
                    let (result1_0, result1_1) = match total {
                        Some(e) => (1i32, _rt::as_i64(e)),
                        None => (0i32, 0i64),
                    };
                    let (result3_0, result3_1, result3_2) = match message {
                        Some(e) => {
                            let vec2 = e;
                            let ptr2 = vec2.as_ptr().cast::<u8>();
                            let len2 = vec2.len();
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn emit_chunk(content: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
        ...
        pub mod store {
            ...
            pub fn get(key: &str) -> Result<Option<_rt::String>, Error> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:config/store@0.2.0-draft-2024-09-27"
                    )]
                    unsafe extern "C" {
                        #[link_name = "get"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
    ...
    pub mod nextclaw {
        pub mod portable_service {
            ...
            pub mod resident_v2 {
                ...
                impl ::core::fmt::Debug for Retry {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        f.debug_struct("Retry")
                            .field("delay-ms", &self.delay_ms)
                ...
                impl ::core::fmt::Debug for EventDisposition {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        match self {
                            EventDisposition::Ack => {
                                f.debug_tuple("EventDisposition::Ack").finish()
                            }
                            EventDisposition::Retry(e) => {
                                f.debug_tuple("EventDisposition::Retry").field(e).finish()
                            }
                        }
                    }
                }
                ...
                pub trait Guest {
                    ...
                    ) -> Result<EventDisposition, _rt::String>;
                    fn stop(
                        reason_json: _rt::String,
                    ) -> Result<_rt::String, _rt::String>;
                }
                #[doc(hidden)]
                macro_rules! __export_nextclaw_portable_service_resident_v2_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "nextclaw:portable-service/resident-v2@0.1.0#list-actions")]
                        unsafe extern "C" fn export_list_actions() -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_list_actions_cabi::<$ty > () } }
                        #[unsafe (export_name =
                        "cabi_post_nextclaw:portable-service/resident-v2@0.1.0#list-actions")]
                        unsafe extern "C" fn _post_return_list_actions(arg0 : * mut u8,)
                        { unsafe { $($path_to_types)*:: __post_return_list_actions::<$ty
                        > (arg0) } } #[unsafe (export_name =
                        "nextclaw:portable-service/resident-v2@0.1.0#invoke")] unsafe
                        ...
                        * mut u8, arg3 : usize,) -> * mut u8 { unsafe {
                        ...
                        "cabi_post_nextclaw:portable-service/resident-v2@0.1.0#invoke")]
                        unsafe extern "C" fn _post_return_invoke(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*:: __post_return_invoke::<$ty > (arg0)
                        } } #[unsafe (export_name =
                        "nextclaw:portable-service/resident-v2@0.1.0#start")] unsafe
                        extern "C" fn export_start(arg0 : * mut u8, arg1 : usize,) -> *
                        mut u8 { unsafe { $($path_to_types)*:: _export_start_cabi::<$ty >
                        (arg0, arg1) } } #[unsafe (export_name =
                        "cabi_post_nextclaw:portable-service/resident-v2@0.1.0#start")]
                        unsafe extern "C" fn _post_return_start(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*:: __post_return_start::<$ty > (arg0)
                        } } #[unsafe (export_name =
                        "nextclaw:portable-service/resident-v2@0.1.0#handle-event")]
                        unsafe extern "C" fn export_handle_event(arg0 : * mut u8, arg1 :
                        usize,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_handle_event_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name =
                        "cabi_post_nextclaw:portable-service/resident-v2@0.1.0#handle-event")]
                        unsafe extern "C" fn _post_return_handle_event(arg0 : * mut u8,)
                        { unsafe { $($path_to_types)*:: __post_return_handle_event::<$ty
                        > (arg0) } } #[unsafe (export_name =
                        "nextclaw:portable-service/resident-v2@0.1.0#stop")] unsafe
                        extern "C" fn export_stop(arg0 : * mut u8, arg1 : usize,) -> *
                        mut u8 { unsafe { $($path_to_types)*:: _export_stop_cabi::<$ty >
                        (arg0, arg1) } } #[unsafe (export_name =
                        "cabi_post_nextclaw:portable-service/resident-v2@0.1.0#stop")]
                        unsafe extern "C" fn _post_return_stop(arg0 : * mut u8,) { unsafe
                        { $($path_to_types)*:: __post_return_stop::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_nextclaw_portable_service_resident_v2_0_1_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_service_app_v2_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::nextclaw::portable_service::resident_v2::__export_nextclaw_portable_service_resident_v2_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::nextclaw::portable_service::resident_v2);
    };
}
#[doc(inline)]
pub(crate) use __export_service_app_v2_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:nextclaw:portable-service@0.1.0:service-app-v2:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7640] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd3:\x01A\x02\x01A\x1b\
\x01B'\x01m\x04\x05debug\x04info\x04warn\x05error\x04\0\x09log-level\x03\0\0\x01\
r\x02\x06status{\x04bodys\x04\0\x0dhttp-response\x03\0\x02\x01r\x03\x0arunner-pi\
dy\x11loaded-componentsy\x0ccomponent-ids\x04\0\x0cruntime-info\x03\0\x04\x01ky\x01\
r\x03\x07slot-ids\x0dmessages-jsons\x0amax-tokens\x06\x04\0\x14model-complete-in\
put\x03\0\x07\x01r\x02\x07slot-ids\x0ainput-jsons\x04\0\x11agent-start-input\x03\
\0\x09\x01@\x02\x05level\x01\x07messages\x01\0\x04\0\x03log\x01\x0b\x01ks\x01j\x01\
\x0c\x01s\x01@\x01\x03keys\0\x0d\x04\0\x06kv-get\x01\x0e\x01j\0\x01s\x01@\x02\x03\
keys\x05values\0\x0f\x04\0\x06kv-set\x01\x10\x01j\x01\x03\x01s\x01@\x01\x03urls\0\
\x11\x04\0\x08http-get\x01\x12\x01j\x01s\x01s\x01@\x03\x0bprovider-ids\x06action\
s\x0ainput-jsons\0\x13\x04\0\x0ecomponent-call\x01\x14\x01@\0\0\x05\x04\0\x10get\
-runtime-info\x01\x15\x01@\x01\x05input\x08\0\x13\x04\0\x0emodel-complete\x01\x16\
\x01@\x01\x05input\x0a\0\x13\x04\0\x0bagent-start\x01\x17\x01kw\x01@\x03\x07curr\
ent\x18\x05total\x18\x07message\x0c\0\x0f\x04\0\x0freport-progress\x01\x19\x01@\x01\
\x07contents\0\x0f\x04\0\x0aemit-chunk\x01\x1a\x01@\0\0\x7f\x04\0\x0fcheck-cance\
lled\x01\x1b\x03\0$nextclaw:portable-service/host@0.1.0\x05\0\x01B\x0a\x04\0\x08\
...
@0.2.6\x05\x01\x02\x03\0\x01\x08pollable\x01B\x0f\x02\x03\x02\x01\x02\x04\0\x08p\
...
ock@0.2.6\x05\x03\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04self\x01\0s\
\x04\0\x1d[method]error.to-debug-string\x01\x02\x03\0\x13wasi:io/error@0.2.6\x05\
\x04\x02\x03\0\x03\x05error\x01B(\x02\x03\x02\x01\x05\x04\0\x05error\x03\0\0\x02\
\x03\x02\x01\x02\x04\0\x08pollable\x03\0\x02\x01i\x01\x01q\x02\x15last-operation\
...
2.6\x05\x06\x02\x03\0\x02\x08duration\x02\x03\0\x04\x0cinput-stream\x02\x03\0\x04\
\x0doutput-stream\x01B\xc1\x01\x02\x03\x02\x01\x07\x04\0\x08duration\x03\0\0\x02\
\x03\x02\x01\x08\x04\0\x0cinput-stream\x03\0\x02\x02\x03\x02\x01\x09\x04\0\x0dou\
tput-stream\x03\0\x04\x02\x03\x02\x01\x05\x04\0\x08io-error\x03\0\x06\x02\x03\x02\
\x01\x02\x04\0\x08pollable\x03\0\x08\x01q\x0a\x03get\0\0\x04head\0\0\x04post\0\0\
...
e\x01\x8d\x01\x03\0\x15wasi:http/types@0.2.6\x05\x0a\x02\x03\0\x05\x10outgoing-r\
equest\x02\x03\0\x05\x0frequest-options\x02\x03\0\x05\x18future-incoming-respons\
e\x02\x03\0\x05\x0aerror-code\x01B\x0f\x02\x03\x02\x01\x0b\x04\0\x10outgoing-req\
uest\x03\0\0\x02\x03\x02\x01\x0c\x04\0\x0frequest-options\x03\0\x02\x02\x03\x02\x01\
\x0d\x04\0\x18future-incoming-response\x03\0\x04\x02\x03\x02\x01\x0e\x04\0\x0aer\
...
ttp/outgoing-handler@0.2.6\x05\x0f\x01B\x0b\x01q\x02\x08upstream\x01s\0\x02io\x01\
s\0\x04\0\x05error\x03\0\0\x01ks\x01j\x01\x02\x01\x01\x01@\x01\x03keys\0\x03\x04\
\0\x03get\x01\x04\x01o\x02ss\x01p\x05\x01j\x01\x06\x01\x01\x01@\0\0\x07\x04\0\x07\
get-all\x01\x08\x03\0(wasi:config/store@0.2.0-draft-2024-09-27\x05\x10\x01B\x15\x01\
r\x03\x04names\x05titles\x0bdescriptions\x04\0\x06action\x03\0\0\x01ky\x01ks\x01\
r\x03\x08delay-ms\x02\x0aerror-code\x03\x0derror-message\x03\x04\0\x05retry\x03\0\
\x04\x01q\x02\x03ack\0\0\x05retry\x01\x05\0\x04\0\x11event-disposition\x03\0\x06\
\x01p\x01\x01@\0\0\x08\x04\0\x0clist-actions\x01\x09\x01j\x01s\x01s\x01@\x02\x06\
actions\x0ainput-jsons\0\x0a\x04\0\x06invoke\x01\x0b\x01@\x01\x0bconfig-jsons\0\x0a\
\x04\0\x05start\x01\x0c\x01j\x01\x07\x01s\x01@\x01\x0aevent-jsons\0\x0d\x04\0\x0c\
handle-event\x01\x0e\x01@\x01\x0breason-jsons\0\x0a\x04\0\x04stop\x01\x0f\x04\0+\
nextclaw:portable-service/resident-v2@0.1.0\x05\x11\x04\0.nextclaw:portable-serv\
ice/service-app-v2@0.1.0\x04\0\x0b\x14\x01\0\x0eservice-app-v2\x03\0\0\0G\x09pro\
